...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/ideago-llm-image-70b)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/ideago-llm-image-70b
```

A live public deployment of this template is available at [https://ideago-llm-image-70b.templates.workers.dev](https://ideago-llm-image-70b.templates.workers.dev)
